...
''';
  ...
  void selectHospital(String name) {
    setState(() {
...
class _MapScreenState extends State<MapScreen> {
  ...
  Map<String, dynamic>? get selectedHospitalData {
  ...
  Future<void> loadRoute() async {
    final hospital = selectedHospitalData;

    if (hospital == null) {
      return;
    }

    final startLat = widget.position.latitude;
    final startLng = widget.position.longitude;

    final endLat = hospital['lat'] as double;
    final endLng = hospital['lng'] as double;
    ...
    try {
      ...
      if (response.statusCode != 200) {
        throw Exception(
          'Routing server error: ${response.statusCode}',
        );
      }
  ...
  void fitRoute() {
    ...
    double minLat = roadRoute.first.latitude;
    double maxLat = roadRoute.first.latitude;
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0;
        i < widget.trafficSignals.length;
        i++) {
      final signal =
          widget.trafficSignals[i];
        ...
        children: [
          ...
          FlutterMap(
            ...
            options: MapOptions(
              ...
              // IMPORTANT:
              // Allows map drag, zoom and all gestures.
              interactionOptions:
                        ...
                        children: [
                          ...
                          Text(
                            loadingRoute
                                ...
                                : routeError.isNotEmpty
                                    ? routeError
                                    : roadRoute.isNotEmpty
            ...
            child: Column(
              children: [
                FloatingActionButton.small(
                  heroTag: 'ambulanceButton',
                  backgroundColor: Colors.white,
                  onPressed: goToAmbulance,
                  child: const Icon(
                    Icons.my_location,
                    color: Colors.blue,
                  ),
                ...
                FloatingActionButton.small(
                  heroTag: 'hospitalButton',
                  backgroundColor: Colors.white,
                  onPressed: goToHospital,
                  child: const Icon(
                    Icons.local_hospital,
                    color: Colors.red,
                  ),
...
class TrafficDashboard extends StatelessWidget {
        ...
        child: Column(
          children: [
            ...
            ...List.generate(
              trafficSignals.length,
              (index) {
                final signal = trafficSignals[index];
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      corridorActive
                          ? 'Emergency vehicle has traffic priority.'
                          : 'Send SOS and activate Green Corridor.',
                      textAlign: TextAlign.center,
                    ),
                  ],
                ),
  ...
  Widget signalCard(
    ...
    final active =
        corridorActive && activeSignalIndex == index;
